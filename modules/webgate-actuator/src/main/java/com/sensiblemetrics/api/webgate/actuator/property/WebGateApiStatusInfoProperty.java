...
public class WebGateApiStatusInfoProperty {
     ...
     */
    public static final String PROPERTY_PREFIX = WebGateApiStatusProperty.PROPERTY_PREFIX + DEFAULT_PROPERTY_DELIMITER + "node.info";
    ...
    private WebGateApiStatusInfoProperty.InfoSettings settings = new InfoSettings();
    ...
    private WebGateApiStatusInfoProperty.InfoParameterNames parameterNames = new InfoParameterNames();
    ...
    private WebGateApiStatusInfoProperty.InfoMetrics metrics = new InfoMetrics();

...
import com.sensiblemetrics.api.webgate.security.property.WebGateEncryptableProperty;
...
@Configuration
@EnableConfigurationProperties(WebGateEncryptableProperty.class)
@ConditionalOnProperty(prefix = WebGateEncryptableProperty.PROPERTY_PREFIX, name = "enabled", havingValue = "true", matchIfMissing = true)
@Role(BeanDefinition.ROLE_INFRASTRUCTURE)
@Description("SensibleMetrics Commons Web Service Security Encryptable configuration")
public abstract class WebGateEncryptableConfiguration {
    /**
    ...
    @ConditionalOnBean(WebGateEncryptableProperty.class)
    @ConditionalOnClass(CustomEncryptablePropertyDetector.class)
    @Description("Security encryptable property detector bean")
    public EncryptablePropertyDetector encryptablePropertyDetector(final WebGateEncryptableProperty property) {
    ...
    @ConditionalOnBean({WebGateEncryptableProperty.class, SimpleStringPBEConfig.class})
    @ConditionalOnClass(CustomEncryptablePropertyResolver.class)
    @Description("Security encryptable property resolver bean")
    public EncryptablePropertyResolver encryptablePropertyResolver(final WebGateEncryptableProperty property,
    ...
    public EncryptablePropertyFilter encryptablePropertyFilter(final WebGateEncryptableProperty property) {
    ...
    public SimpleStringPBEConfig stringEncryptorConfig(final WebGateEncryptableProperty property) {

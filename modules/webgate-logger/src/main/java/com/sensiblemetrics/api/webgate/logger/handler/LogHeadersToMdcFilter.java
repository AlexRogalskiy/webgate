package com.sensiblemetrics.api.webgate.logger.handler;
...
import static com.sensiblemetrics.api.webgate.commons.utils.ServiceUtils.enumerationAsStream;
...
public class LogHeadersToMdcFilter extends OncePerRequestFilter {
    ...
    /**
     * Default {@link LogHeadersToMdcFilter} constructor by input {@link WebGateLoggingProperty.HeadersHandler}
     *
     * @param headersHandler - initial input {@link WebGateLoggingProperty.HeadersHandler}
     */
    public LogHeadersToMdcFilter(final WebGateLoggingProperty.HeadersHandler headersHandler) {

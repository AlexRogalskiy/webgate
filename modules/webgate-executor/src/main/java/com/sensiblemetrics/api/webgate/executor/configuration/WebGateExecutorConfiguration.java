package com.sensiblemetrics.api.webgate.executor.configuration;

import com.sensiblemetrics.api.webgate.executor.handler.DeleagatedRejectedExecutionHandler;
import com.sensiblemetrics.api.webgate.executor.handler.DelegatedAsyncUncaughtExceptionHandler;
import com.sensiblemetrics.api.webgate.executor.handler.DelegatedTimeoutCallableProcessingInterceptor;
...
public abstract class WebGateExecutorConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean
    @ConditionalOnClass(DeleagatedRejectedExecutionHandler.class)
    @Description("Rejected execution handler configuration bean")
    public RejectedExecutionHandler rejectedExecutionHandler() {
        return new DeleagatedRejectedExecutionHandler();
    }

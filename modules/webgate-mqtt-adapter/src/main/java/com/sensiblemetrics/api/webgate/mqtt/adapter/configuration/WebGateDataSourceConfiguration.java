...
@EnableJpaRepositories("com.sensiblemetrics.api.webgate.mqtt.adapter.repository")
@Role(BeanDefinition.ROLE_INFRASTRUCTURE)
@Description("SensibleMetrics WebGate DataSource configuration")
public class WebGateDataSourceConfiguration {
    /**
     ...
     */
    private static final String[] DEFAULT_PACKAGES_TO_SCAN = {"com.sensiblemetrics.api.webgate.mqtt.adapter.model.entity"};

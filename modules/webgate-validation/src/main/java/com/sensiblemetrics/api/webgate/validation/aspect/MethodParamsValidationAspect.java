package com.sensiblemetrics.api.webgate.validation.aspect;

import com.sensiblemetrics.api.webgate.validation.annotation.ValidateInput;
import com.sensiblemetrics.api.webgate.validation.exception.DataValidationException;
import com.sensiblemetrics.api.webgate.validation.model.ValidatorRegistry;
...
@Description("WebGate method parameters validation aspect configuration")
public class MethodParamsValidationAspect {
     ...
     */
    @Pointcut("@annotation(com.sensiblemetrics.api.webgate.validation.annotation.ValidateInput)" +
        "|| @within(com.sensiblemetrics.api.webgate.validation.annotation.ValidateInput)")

...
import com.sensiblemetrics.api.webgate.validation.constraint.validator.StateValidator;
...
public @interface State {
     ...
     */
    String message() default "{com.sensiblemetrics.api.webgate.validation.constraint.annotation.State.message}";

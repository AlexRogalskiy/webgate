...
import com.sensiblemetrics.api.webgate.validation.constraint.validator.UUIDValidator;
...
public @interface UUID {
     ...
     */
    String message() default "{com.sensiblemetrics.api.webgate.validation.constraint.annotation.UUID.message}";

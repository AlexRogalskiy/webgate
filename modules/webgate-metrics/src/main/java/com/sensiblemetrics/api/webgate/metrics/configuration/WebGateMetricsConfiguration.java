...
public abstract class WebGateMetricsConfiguration {
    ...
    public MeterRegistryCustomizer<MeterRegistry> metricsNamingConventionCustomizer(final WebGateMetricsProperty metricsProperty) {
    ...
    @ConditionalOnProperty(prefix = WebGateMetricsProperty.Handlers.MONITORING_TIME_PROPERTY_PREFIX, value = "enabled", havingValue = "true")
    ...
    @ConditionalOnProperty(prefix = WebGateMetricsProperty.Handlers.TRACKING_TIME_PROPERTY_PREFIX, value = "enabled", havingValue = "true")
    ...
    public MeterFilter includeMeterFilter(final WebGateMetricsConfigurerAdapter configurerAdapter,

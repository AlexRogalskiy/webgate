package com.sensiblemetrics.api.webgate.metrics.aspect;
...
public class MonitoringTimeAspect {
    ...
    @Pointcut("@annotation(com.sensiblemetrics.api.webgate.metrics.annotation.MonitoredComponent) " +
            "|| @within(com.sensiblemetrics.api.webgate.metrics.annotation.MonitoredComponent)")
    public void monitoredComponentPointcut() {
    }

    @Pointcut("@annotation(com.sensiblemetrics.api.webgate.metrics.annotation.MonitoredService) " +
            "|| @within(com.sensiblemetrics.api.webgate.metrics.annotation.MonitoredService)")
    public void monitoredServicePointcut() {
    }

    @Pointcut("@annotation(com.sensiblemetrics.api.webgate.metrics.annotation.MonitoredRepository) " +
            "|| @within(com.sensiblemetrics.api.webgate.metrics.annotation.MonitoredRepository)")
    public void monitoredRepositoryPointcut() {
    }

    @Pointcut("(@annotation(com.sensiblemetrics.api.webgate.metrics.annotation.MonitoredComponent) " +
            "|| @within(com.sensiblemetrics.api.webgate.metrics.annotation.MonitoredComponent))" +
            "|| (@annotation(com.sensiblemetrics.api.webgate.metrics.annotation.MonitoredRestController) " +
            "|| @within(com.sensiblemetrics.api.webgate.metrics.annotation.MonitoredRestController))")

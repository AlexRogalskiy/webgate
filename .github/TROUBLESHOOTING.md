...
See the [Upgrading guide](https://github.com/AlexRogalsky/webgate/blob/master/UPGRADE.md).
...
- [ ] Search issues on the [repo](https://github.com/AlexRogalsky/webgate/) for a similar problems?
- [ ] Read the [README](https://github.com/AlexRogalsky/webgate/blob/master/README.md) carefully
...
2. Can you customize the styling or theme?  **A**: See [Customizing](https://github.com/AlexRogalskiy/webgate#customizing-fastpages)

See the [FAQ](https://github.com/AlexRogalskiy/webgate#faq) for frequently asked questions.
